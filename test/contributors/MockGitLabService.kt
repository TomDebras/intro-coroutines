...
object MockGitLabService : GitLabService {
    override fun getOrgReposCall(org: String): Call<List<Repo>> {
        return Calls.response(repos)
    }

    override fun getRepoContributorsCall(repo: String): Call<List<User>> {
    ...
    override suspend fun getRepoContributors(repo: String): Response<List<User>> {
