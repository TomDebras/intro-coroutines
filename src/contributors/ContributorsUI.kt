...
class ContributorsUI : JFrame("GitLab Contributors"), Contributors {
    private val token = JTextField(20)
    ...
    override fun getParams(): Params {
        return Params(token.text, org.text, getSelectedVariant())
    }
}
